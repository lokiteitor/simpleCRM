...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 col-lg-2">
            <div class="form-group">
                <a href='{{url("/detalles/contacto")}}'><button class="btn btn-default"><span class="glyphicon glyphicon-open">Ver Contacto</span></button></a>
            </div>                
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <a href='{{url("/editar/contacto")}}'><button class="btn btn-default"><span class="glyphicon glyphicon-edit">Editar Contacto</span></button></a>
